/**************************************************************************************************
  Filename:       hal_key.c
  Revised:        $Date: 2013-11-12 16:24:39 -0800 (Tue, 12 Nov 2013) $
  Revision:       $Revision: 36057 $
...
*
* @brief   Determine if key was pressed and which key was pressed with no debounce
*
* @param   none
*
* @return  None
