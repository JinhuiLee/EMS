...
uint8 *zclSerializeData( uint8 dataType, void *attrData, uint8 *buf )
{
  ...
  switch ( dataType )
  {
    ...
    case ZCL_DATATYPE_UINT64:
      ...
      break;
    //lhy
    case ZCL_DATATYPE_INT128:
    case ZCL_DATATYPE_UINT128:
      pStr = (uint8*)attrData;
      buf = zcl_memcpy( buf, pStr, 16 );
      break; 
    case ZCL_DATATYPE_INT256:
    case ZCL_DATATYPE_UINT256:
      pStr = (uint8*)attrData;
      buf = zcl_memcpy( buf, pStr, 32 );
      break;
    case ZCL_DATATYPE_UINT512:
      pStr = (uint8*)attrData;
      buf = zcl_memcpy( buf, pStr, 64 );
      break;
    //  
