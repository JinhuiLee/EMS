...
static void zmain_dev_info( void )
{
  ...
  HalLcdWriteString( "IEEE: ", HAL_LCD_LINE_7 );  //lhy
  HalLcdWriteString( (char*)lcd_buf, HAL_LCD_LINE_8 );  //lhy
}
#endif
...
static void zmain_lcd_init( void )
{
#ifdef SERIAL_DEBUG_SUPPORTED
  {
   // HalLcdWriteString( "TexasInstruments", HAL_LCD_LINE_1 );
    HalLcdWriteString( "   WELCOME TO ITU", HAL_LCD_LINE_1 );  //lhy
    HalLcdWriteString( " Embedded System Lab", HAL_LCD_LINE_2 );  //lhy
