 ...
 */
extern uint8 HalUART1Open ( uint8 port, halUARTCfg_t *config );
extern uint8 HalUART0Open ( uint8 port, halUARTCfg_t *config );
/*
 * Close a port
 */
...
extern uint16 HalUART0Read ( uint8 port, uint8 *pBuffer, uint16 length );
/*
 * Write a buff to the uart *
 */
extern uint16 HalUART1Write ( uint8 port, uint8 *pBuffer, uint16 length );
extern uint16 HalUART0Write ( uint8 port, uint8 *pBuffer, uint16 length );
/*
...
extern uint16 Hal_UART0_RxBufLen ( uint8 port );
/*
 * Return the number of bytes in the Tx buffer
 */
extern uint16 Hal_UART_TxBufLen ( uint8 port );
extern uint16 Hal_UART0_TxBufLen ( uint8 port );
/*
